...
public class DynamicSubstring {
    public static void main(String[] args) {
        ...
        System.out.println(result.substring(colonIndex+1)); //before that it printed out the colon, so we did +1 so it starts printing from the next character
         ...
         * find indexOf [
         * find index ]
         * provied them as start, end index for substring
         * to print java
         */
